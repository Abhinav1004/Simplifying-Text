...
class T5BaseLineFineTuned(pl.LightningModule):
    """
    A PyTorch Lightning module for fine-tuning a T5 model for sequence-to-sequence tasks like summarization.

    Args:
        model_name: Pre-trained t5 base model to fine-tune
    """
